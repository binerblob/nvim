  ...
  },
  {
    ...
    config = function ()
      require("cinnamon").setup {
        ...
        vim.keymap.set("n", "<PageUp>", function() require("cinnamon").scroll("<PageUp>") end),
        vim.keymap.set("n", "<PageDown>", function() require("cinnamon").scroll("<PageDown>") end),
        vim.keymap.set("n", "<A-PageUp>", function() require("cinnamon").scroll("<C-u>") end),
        vim.keymap.set("n", "<A-PageDown>", function() require("cinnamon").scroll("<C-d>") end)
      }
    end
  },
  {
